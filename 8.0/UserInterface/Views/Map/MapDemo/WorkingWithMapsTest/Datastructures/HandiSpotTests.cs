...
namespace WorkingWithMapsTest.Datastructures
{
    ...
    public class HandiSpotTests {
        ...
        private HandiSpot createDummyHandiSpot() {
            ...
            return new HandiSpot("id", "name", date, new GeoCoordinate(25.25, 50.50), 1000, Paiement.FREE, false, true, "https://upload.wikimedia.org/wikipedia/commons/8/85/Logo-Test.png");
        }

        private List<string> createDummyGoogleSheetEntry()
        {
            return new List<string>(new string[] { "id2", "name2", "2018-02-18 11:10:13Z", "75.75", "100.100", "2000", "FREE", "TRUE", "TRUE" });
        }
        ...
        public void HandiSpotToGSheetTest()
        {
            ...
            Assert.Equal(10, googleSheetEntry.Count);
            ...
            Assert.Equal("https://upload.wikimedia.org/wikipedia/commons/8/85/Logo-Test.png", googleSheetEntry[9]);
        }
